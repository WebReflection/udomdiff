...
assert(typeof udomdiff === 'function', 'is a function');
...
console.log('## removal of elements');
...
console.log('## element reordering');
...
clean();
console.log('## updating children (unpinned)');
newState = domdiff(
  document.body,
  [],
  [nodes.a]
...
console.log('## removal of elements (unpinned)');
...
console.log('## element reordering (unpinned)');
...
console.log('## combination (unpinned)');
...
console.log('## random values (unpinned)');
